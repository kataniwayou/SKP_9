...
namespace BaseApi.Service.Persistence.Migrations
{
    ...
    [Migration("20260923052709_AddWorkflowDiagram")]
    partial class AddWorkflowDiagram
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseApi.Service.Features.Cache.CacheEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("BaseApi.Service.Features.Processor.ProcessorEntity", b =>
                {
                    ...
                    b.HasIndex("SourceHash", "InstanceId")
                        .IsUnique()
            ...
            modelBuilder.Entity("BaseApi.Service.Features.Workflow.WorkflowCaches", b =>
                {
                    b.Property<Guid>("WorkflowId")
                        .HasColumnType("uuid")
                        .HasColumnName("workflow_id");
                    ...
                    b.HasKey("WorkflowId", "CacheId")
                        .HasName("pk_workflow_caches");

                    b.HasIndex("CacheId")
                        .HasDatabaseName("ix_workflow_caches_cache_id");

                    b.ToTable("workflow_caches", (string)null);
                });
            ...
            modelBuilder.Entity("BaseApi.Service.Features.Workflow.WorkflowCaches", b =>
                {
                    b.HasOne("BaseApi.Service.Features.Cache.CacheEntity", null)
                        .WithMany()
